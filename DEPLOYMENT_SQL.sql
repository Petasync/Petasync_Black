...
-- SCHRITT 3: Neue Felder zur invoices Tabelle hinzufügen
...
ALTER TABLE public.invoices ADD COLUMN IF NOT EXISTS discount_type TEXT DEFAULT 'percent' CHECK (discount_type IN ('percent', 'euro'));
